...
class AttacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attack" do
    assert_difference('Attack.count') do
      post attacks_url, params: { attack: { damage_bonus: @attack.damage_bonus, damage_dice: @attack.damage_dice, description: @attack.description, name: @attack.name } }
    end
  ...
  test "should update attack" do
    patch attack_url(@attack), params: { attack: { damage_bonus: @attack.damage_bonus, damage_dice: @attack.damage_dice, description: @attack.description, name: @attack.name } }
