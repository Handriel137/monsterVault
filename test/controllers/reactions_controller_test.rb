...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference('Reaction.count') do
      post reactions_url, params: { reaction: { attack_bonus: @reaction.attack_bonus, description: @reaction.description, name: @reaction.name } }
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { attack_bonus: @reaction.attack_bonus, description: @reaction.description, name: @reaction.name } }
